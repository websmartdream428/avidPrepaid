  ...
  return (
    <div className="rounded-[30px] bg-[#f0f2f6] w-full max-w-[395px] mb-5">
      <div className="-mt-[2.5em] pt-0 p-[25px]">
        ...
        <h1 className="mb-[15px] text-[1.1em] pl-[35px] font-bold leading-[44px] -tracking-[1px]">
          {props.title}
        </h1>
        {props.children}
      </div>
  ...
  return (
    <Container>
      <div id="services" className="md:py-16 py-3 w-full m-auto md:px-[15px]">
        <div className="grid lg:grid-cols-4 sm:grid-cols-2 mt-[42px] gap-10 justify-center">
