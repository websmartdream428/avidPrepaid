    ...
    <div className="landing-intro pt-12">
      <div className="max-w-[1200px] constrain lg:flex-row flex-col flex landing-header mb-4 m-auto">
        <img
          src={logo}
          alt="logo"
          className="logo-img h-10 cursor-pointer"
        />
        <div
          className="flex-grow pt-1"
        >
          <ul
            className="flex flex-row text-center mx-auto w-full max-w-xs font-bold text-white"
          >
